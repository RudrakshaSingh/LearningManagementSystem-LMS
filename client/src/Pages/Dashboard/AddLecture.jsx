...
function AddLecture() {
    ...
    function handleVideo(e) {
        ...
        const source = window.URL.createObjectURL(video); //convert vedio into url
        setUserInput({
            ...userInput,
            lecture: video,
            videoSrc: source,
    ...
    useEffect(() => {
        if (!courseDetails) navigate("/courses"); //sothat if you go directly to url (so you will not have coursedetail in state)
    }, []);
                        ...
                        {userInput.videoSrc ? (
                            ...
                            <div className="h-48 border flex items-center justify-center cursor-pointer">
                                ...
                                <input
                                    ...
                                    accept="video/mp4 video/x-mp4 video/*" ///*for all types
                                />
                            </div>
                        )}
