    ...
    return (
        <HomeLayout>
            <div className="flex flex-col gap-10 items-center justify-center min-h-[90vh] py-10 text-wihte mx-[5%]">
                <div className="text-center text-2xl font-semibold text-yellow-500">Course Name: {state?.title}</div>

                {/* so that it doesnt appear when lectures are 0 */}
                    ...
                    <div className="flex justify-center gap-10 w-full">
                        ...
                        <div className="space-y-5 w-[28rem] p-2 rounded-lg shadow-[0_0_10px_black]">
                            <video
                                ...
                                muted
                                controlsList="nodownload" //to remove download
                            ></video>
                            <div>
                                <h1>
