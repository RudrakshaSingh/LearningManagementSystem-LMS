			...
			<div className="min-h-[90vh] bg-teal-50 py-16 px-4 sm:px-8 lg:px-16">
				<div className="max-w-7xl mx-auto">
					<div className="bg-white rounded-2xl shadow-lg p-8">
						<Link to="/courses" className="flex items-center text-teal-600 hover:text-teal-800 mb-6">
						...
						<form onSubmit={onFormSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-8">
							...
							<div className="space-y-6">
								<div>
									<label className="block text-gray-700 font-semibold mb-2" htmlFor="createdBy">
										Course Instructor
									</label>
									<input
										required
